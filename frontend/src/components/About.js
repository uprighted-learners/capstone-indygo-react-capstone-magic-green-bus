...
export default function Home() {
  return (
    <>
     <img className='hero-image'src= {myImage}></img>
     ...
     <p className='paragraph-hero'>Indiana's bus service history is deeply intertwined with the evolution of public transportation in the United States. The state's bus service began in the early 20th century as an answer to the growing need for efficient and affordable mass transit. The rise of the automobile had reduced the demand for interurban railways, prompting cities and towns to explore bus services as a flexible and cost-effective alternative. The earliest buses were often converted trucks, which provided a rudimentary but essential service, linking rural areas to urban centers and helping to foster economic growth and social mobility.
...
this is all info about bus stops in indiana</p>
    </>
  );
}
